            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-content mb-2 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10">
                            <p class="mb-4">Rapidiously evisculate user-centric functionalities for highly efficient
            ...
            <div class="row">
                <div class="col-xl-6 mb-30 mb-xl-0">
                    <div class="about-content">
                        ...
                        <p class="pe-xl-2 text-title">Proactively revolutionize granular customer service after pandemic
                            internal or "organic" sources. Distinctively impact proactive human capital rather than
                            client-centered benefits. </p>
                        <div class="row pt-3">
                            <div class="col-sm-6 col-lg-5 col-xl-6">
                                <div class="d-flex mb-25">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="mb-0 fs-xs">Professional web-readiness via ubiquitous human capital.
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="position-relative">
            <div class="d-none d-md-block bg-top-right position-absolute start-0 top-0 w-100 h-100"
                data-bg-src="assets/img/bg/testimonial-shape-1.png"></div>
                    ...
                    <div class="pl-30 no-pl-md mt-2 mt-md-0 position-relative">
                        ...
                        <div class="vs-carousel testimonail-desc-slide text-center text-md-start" data-dots="true"
                            ...
                            <div class="testimonail-desc">
                                ...
                                <p class="mb-0 testi-text">Objectively unleash resource maximizing networks vis-a-vis
                                    parallel services. Continually parallel task real-time users without global sources.
                                    Credibly provide access to parallel resources whereas worldwide. </p>
                            </div>
                            <div class="testimonail-desc">
                                <div class="testi-rating">
                                    <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span
                                ...
                                <p class="mb-0 testi-text">OLorem ipsum dolor sit amet, consectetur adipiscing elit.
                                    Nam hendrerit nisi sed sollicitudin pellentesque. Nunc posuere purus rhoncus
                                    pulvinar aliquam. Ut aliquet tristique nisl vitae volutpat. Nulla aliquet. </p>
                            </div>
                            <div class="testimonail-desc">
                                <div class="testi-rating">
                                    <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span
                                ...
                                <p class="mb-0 testi-text">Nick Richardson described the translation “like extreme
                                    Mallarmé, or a Burroughsian cut-up, or a paragraph of Finnegans Wake. Bits of it
                                    have surprising power: the desperate insistence on loving hitch and, an </p>
                            </div>
                        </div>
                    </div>
                </div>
